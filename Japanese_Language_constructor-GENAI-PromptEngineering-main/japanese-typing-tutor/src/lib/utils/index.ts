...
export function japaneseToRomaji(japanese: string): string {
...
export function calculateWPM(timeInSeconds: number, wordsTyped: number): number {
...
export function calculateScore(wpm: number, accuracy: number, baseScore: number = 100): number {
  const wpmWeight = 0.6;
